      ...
      <tbody>
        <?php foreach ($places as $place): ?>
          <tr>
            ...
            <td>
              <a href="?removePlace=<?= htmlspecialchars($place['placeId']) ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this place?');">Delete</a>
            </td>
          </tr>
        <?php endforeach; ?>
      </tbody>
